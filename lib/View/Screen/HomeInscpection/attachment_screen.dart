...
//       final String capturedImagePath = result["image"].toString();

//       log(
//         "📸 Captured image path: $capturedImagePath",
//       );

//       // 🔹 Compress image before storing/submitting
//       final String? compressedImagePath =
//           await _compressImage(capturedImagePath);
...
//       setState(() {
//         if (isBefore) {
//           beforeImageList.add(compressedImagePath);
//         } else {
//           afterImageList.add(compressedImagePath);
//         }
//       });

//       // 🔹 Update localStorage after compressed image is added
//       _onFieldChanged();
//     }
//   }
